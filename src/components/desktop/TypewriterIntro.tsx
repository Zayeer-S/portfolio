      ...
      <div className="text-center w-full max-w-4xl">
        <div className="space-y-2">
          ...
          <div
            ...
            aria-atomic="true"
          >
            <span>{completedLines[0] || (currentLineIndex === 0 ? displayedText : '')}</span>
            <span
              className="inline-block w-0.5 h-5 sm:h-7 md:h-8 ml-1"
              style={{ minWidth: '2px' }}
              aria-hidden="true"
            >
              {currentLineIndex === 0 && (
          ...
          <div
            ...
            aria-atomic="true"
          >
            <span>{completedLines[1] || (currentLineIndex === 1 ? displayedText : '')}</span>
            <span
              className="inline-block w-0.5 h-5 sm:h-7 md:h-8 ml-1"
              style={{ minWidth: '2px' }}
              aria-hidden="true"
