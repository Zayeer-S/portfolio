...
export default function Taskbar({
  ...
  const orderedWindowIds = useMemo(() => {
    return taskbarOrder
      .filter(id => currentWindowIds.includes(id))
  ...
  const handleTouchStart = useCallback(
    (e: React.TouchEvent, windowId: string) => {
  ...
  const updateInsertionPosition = useCallback(
    (clientX: number) => {
  ...
  useEffect(() => {
    ...
    dragLogic.draggedItem,
    dragLogic.hasDraggedBeyondThreshold,
